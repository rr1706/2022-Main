...
public class TwoBallTwo extends SequentialCommandGroup {
    ...
    public TwoBallTwo(Drivetrain drivetrain, Intake leftIntake, Intake rightIntake, Elevator bottom, Elevator top, Turret turret, ShooterHood hood, Shooter shooter, Climber climb, XboxController driverController, XboxController operatorController){
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new SequentialCommandGroup(
                    twoBallPath2.raceWith(new RunIntake(leftIntake).alongWith(new RunIntake(rightIntake)).alongWith(new IndexElevator(top, bottom, driverController, operatorController))),
