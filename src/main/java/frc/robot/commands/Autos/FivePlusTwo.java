...
public class FivePlusTwo extends SequentialCommandGroup {

        private final Drivetrain m_drive;
        private final Intake m_left;
        private final Intake m_right;

    public FivePlusTwo(Drivetrain drivetrain, Intake leftIntake, Intake rightIntake, Elevator bottom, Elevator top,
        ...
        addCommands(
                ...
                new ParallelCommandGroup(
                        ...
                        new SequentialCommandGroup(
                                move1.raceWith(new RunIntake(leftIntake), new WaitCommand(2.25).raceWith(new IndexElevator(top, bottom)).andThen(m_autoFeed)),
