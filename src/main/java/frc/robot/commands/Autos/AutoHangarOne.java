...
public class AutoHangarOne extends SequentialCommandGroup{
    ...
    public AutoHangarOne(Drivetrain drivetrain, Intake leftIntake, Intake rightIntake, Elevator bottom, Elevator top, Turret turret, ShooterHood hood, Shooter shooter, Climber climb, ColorSensor color){
