...
public class AutoHangarTwo extends SequentialCommandGroup {
    ...
    public AutoHangarTwo(Drivetrain drivetrain, Intake leftIntake, Intake rightIntake, Elevator bottom, Elevator top,
        ...
        final AutoFromPathPlanner DefensivePt3 = new AutoFromPathPlanner(drivetrain, "20222BallPlus2-tres", 3.2, true);
        ...
        addCommands(
                ...
                new ParallelRaceGroup(
                        new SequentialCommandGroup(
                                DefensivePt3.raceWith(new IndexElevator(top, bottom, color, shooter, hood, turret).alongWith(new RunIntake(leftIntake)
